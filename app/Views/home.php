        ...
        <div class="contact-grid">
            <div class="contact-info fade-in">
                <div class="contact-item">
                    ...
                    <a href="mailto:contact.edwyn@gmail.com" class="color-gray-800"><span>contact.edwyn@gmail.com</span></a>
                </div>
                <div class="contact-item">
                    <i class="fa-solid fa-phone" aria-hidden="true" style="font-size:1.3em;color:#6c757d;"></i>
                    <a href="tel:+33603086036" class="color-gray-800"><span>+33 6 03 08 60 36</span></a>
                </div>
                <div class="contact-item">
                    <i class="fa-solid fa-location-dot" aria-hidden="true" style="font-size:1.3em;color:#6c757d;"></i>
                    <a href="https://maps.app.goo.gl/ZPzH6JdsfVmmhtKB9" target="_blank" rel="noopener noreferrer" class="color-gray-800"><span>Nord (59), France</span></a>
                </div>
                <div class="contact-item">
